...
class ClientUI:
    def __init__(self):
        ...
        self.__dict_color = {1: "white", 2: "black"}
    ...
    def __handle_widget(self, canvas):
        ...
        bt_self = tk.Button(canvas, text="OK", font=("Arial 7 bold"), width=1, height=1,
                            command=lambda: self.__oval_join_self(canvas, entry_self_row_obj, entry_self_col_obj,
    ...
    def __oval_join_self(self, canvas, entry_obj_row, entry_obj_col, entry_info_row, entry_info_col):
